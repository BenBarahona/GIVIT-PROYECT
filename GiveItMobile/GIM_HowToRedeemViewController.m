//
//  GIM_HowToRedeemViewController.m
//  GiveItMobile
//
...
#import "GIM_HowToRedeemViewController.h"

@interface GIM_HowToRedeemViewController ()

@end

@implementation GIM_HowToRedeemViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    self.navigationController.title = @"How To Redeem";
